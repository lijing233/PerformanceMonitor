          ...
          switch (
            ...
            case "object":
              ...
              if (rep && "object" == typeof rep)
                for (a = rep.length, r = 0; r < a; r += 1)
                  "string" == typeof rep[r] &&
                    ((s = rep[r]),
                    (n = str(s, c)),
                    n && i.push(quote(s) + (gap ? ": " : ":") + n));
              else
                for (s in c)
        ...
        (_.extend = function (e) {
              ...
              return (
                ...
                u <= 0 || u > t
                  ? (i && (clearTimeout(i), (i = null)),
                    ...
                    (a = e.apply(s, n)),
                    i || (s = n = null))
                  : i || r.trailing === !1 || (i = setTimeout(c, u)),
                a
              );
            };
          }),
          ...
          (_.base64Encode = function (e) {
            ...
            do
              (t = e.charCodeAt(u++)),
                ...
                (o = 63 & c),
                (f[p++] =
                  d.charAt(n) + d.charAt(a) + d.charAt(i) + d.charAt(o));
            while (u < e.length);
          ...
          (_.urlParse = function (e) {
            ...
            return (
              ...
              (t.prototype._parse = function (e) {
                ...
                (this._values.Hostname = this._values.Host.replace(
                  /:\d+$/,
                  ""
                )),
                  (this._values.Origin =
          ...
          (_.addEvent = function () {
            ...
            (e._getPath = function () {
              ...
              return (
                this.path || (this.composedPath && this.composedPath()) || t()
              );
            }),
          ...
          (_.cookie = {
            get: function (e) {
              for (
                ...
                if (0 == n.indexOf(t))
                  return _.decodeURIComponent(n.substring(t.length, n.length));
              }
              return null;
            },
            set: function (e, t, r, s, n) {
              ...
              if (0 !== r) {
                ...
                "s" === String(r).slice(-1)
                  ? d.setTime(
                      d.getTime() + 1e3 * Number(String(r).slice(0, -1))
                    )
              ...
              n && (o = "; secure"),
                (document.cookie =
                  e + "=" + encodeURIComponent(t) + i + "; path=/" + a + o);
            },
            remove: function (e, t) {
          ...
          (_.getEleInfo = function (e) {
            ...
            return (
              t.textContent
                ? (n = _.trim(t.textContent))
                : t.innerText && (n = _.trim(t.innerText)),
              n &&
                (n = n
                  .replace(/[\r\n]/g, " ")
                  .replace(/[ ]+/g, " ")
            ...
            if (_.isArray(t) && t.length >= 2 && !/^(\d+\.)+\d+$/.test(e))
              for (var r = "." + t.splice(t.length - 1, 1); t.length > 0; )
                if (
                  ...
                  document.cookie.indexOf("sensorsdata_domain_test=true") !==
                    -1)
                ) {
                  var s = new Date();
                  return (
            ...
            ("$referrer" in e.properties &&
              (e.properties.$referrer_host =
                "" === e.properties.$referrer
                  ? ""
                  : _.getHostname(e.properties.$referrer, t)),
            sd.para.preset_properties.latest_referrer &&
              ...
              (e.properties.$latest_referrer_host =
                "" === e.properties.$latest_referrer
                  ? ""
                  : _.getHostname(e.properties.$latest_referrer, t))));
      }),
      ...
      (sd.initPara = function (e) {
        ...
        "object" == typeof localStorage
          ? sd.para.batch_send === !0
            ? ((sd.para.batch_send = _.extend({}, n)),
              (sd.para.use_client_time = !0))
            : "object" == typeof sd.para.batch_send &&
              ((sd.para.use_client_time = !0),
              (sd.para.batch_send = _.extend({}, n, sd.para.batch_send)))
        ...
        if (
          ("object" == typeof sd.para.source_type &&
            ...
            (sd.para.source_type.search = _.isArray(sd.para.source_type.search)
              ? sd.para.source_type.search.concat(i)
              : i),
            ...
            (sd.para.source_type.keyword = _.isObject(
              ...
              ? _.extend(c, sd.para.source_type.keyword)
              : c)),
          ...
          for (s = 0; s < sd.para.server_url.length; s++)
            /sa\.gif[^\/]*$/.test(sd.para.server_url[s]) ||
              (sd.para.server_url[s] = sd.para.server_url[s]
                .replace(/\/sa$/, "/sa.gif")
                .replace(/(\/sa)(\?[^\/]+)$/, "/sa.gif$2"));
        else
    ...
    var commonWays = {
      ...
      trackHeatMap: function (e, t, r) {
        if ("object" == typeof e && e.tagName) {
          ...
          "button" === s ||
            ...
            "input" === s ||
            "textarea" === s ||
            _.hasAttribute(e, "data-sensors-click") ||
      ...
      autoTrack: function (e, t) {
        ...
        var r = _.info.campaignParams(),
          s = {};
        for (var n in r)
          (" " + sd.source_channel_standard + " ").indexOf(" " + n + " ") !== -1
            ? (s["$" + n] = r[n])
            : (s[n] = r[n]);
        sd.is_first_visitor &&
          !e.not_set_profile &&
        ...
        return (
          sd.para.preset_properties.latest_referrer &&
            ...
            (r.$latest_referrer_host =
              "" === r.$latest_referrer
                ? ""
                : _.getHostname(r.$latest_referrer)),
          r
        );
      }),
      (BatchSend.prototype = {
        ...
        sendPrepare: function (e) {
          ...
          if (s > 0)
            if (s <= r) this.send({ keys: e.keys, vals: t });
              ...
              for (var n = 0; n * r < s; n++)
                this.send({ keys: e.keys.splice(0, r), vals: t.splice(0, r) });
        },
        sendStrategy: function () {
          ...
          e.keys.length > 0 &&
            ...
            ((this.sendingData = Math.ceil(
              e.vals.length / sd.para.batch_send.one_send_max_length
            )),
            this.sendPrepare(e));
        },
          ...
          for (
            ...
            0 === i.indexOf("sawebjssdk-") &&
              ...
              r
                ? ((r = _.safeJSONParse(r)),
                  r && _.isObject(r)
                    ? ((r._flush_time = s), e.push(i), t.push(r))
        ...
        if (sd.para.use_app_track === !0 || "only" === sd.para.use_app_track)
          if (
            ...
            SensorsData_APP_JS_Bridge.sensorsdata_verify
              ? SensorsData_APP_JS_Bridge.sensorsdata_verify(
                  JSON.stringify(
                    _.extend({ server_url: sd.para.server_url }, s)
                  )
                )
                ? "function" == typeof r && r()
                : sd.para.use_app_track_is_send &&
            ...
            sd.para.use_app_track === !0 &&
              sd.para.use_app_track_is_send === !0 &&
    ...
    (saEvent.checkOption = {
      ...
      (saEvent.debugPath = function (e, t) {
        var r = e,
          s = "";
        (s =
          sd.para.debug_mode_url.indexOf("?") !== -1
            ? sd.para.debug_mode_url +
              "&data=" +
    ...
    var store = (sd.store = {
      ...
      saNewUser = {
        ...
        setDeviceId: function (e) {
          ...
          null != r &&
            _.isJSONString(r) &&
            ((s = JSON.parse(r)), s.$device_id && (t = s.$device_id)),
            (t = t || e),
      ...
      heatmap = (sd.heatmap = {
        ...
        getDomIndex: function (e) {
          ...
          for (
            var t = 0, r = e.tagName, s = e.parentNode.children, n = 0;
            n < s.length;
            n++
          )
            if (s[n].tagName === r) {
        ...
        start: function (e, t, r, s, n) {
          ...
          (c = _.extend(c, a)),
            "a" === r && sd.para.heatmap && sd.para.heatmap.isTrackLink === !0
              ? _.trackLink({ event: e, target: t }, "$WebClick", c)
          ...
          var e = function () {
            ...
            r = t({
              ...
              func: function (e, t) {
                ...
                ((n > sd.para.heatmap.scroll_delay_time &&
            ...
            void ("all" === sd.para.heatmap.collect_elements
              ...
              : _.addEvent(document, "click", function (t) {
                  ...
                  if (
                    ...
                    "input" === n ||
                    "textarea" === n ||
                    _.hasAttribute(s, "data-sensors-click")
                  )
                    e.start(r, s, n);
                  else if (
                    ...
                    e.start(r, a, s.parentNode.tagName.toLowerCase());
                  else if (
                    "area" === n &&
                    "map" === a.tagName.toLowerCase() &&
                    _.ry(a).prev().tagName &&
                    "img" === _.ry(a).prev().tagName.toLowerCase()
                  )
                    e.start(
                      r,
                      _.ry(a).prev(),
                      _.ry(a).prev().tagName.toLowerCase()
                    );
                  else {
            ...
            ? (heatmap.setNotice(n),
              _.sessionStorage.isSupport() &&
                ...
                s && s[0] && s[1]
                  ? "1" === s[1] || "2" === s[1] || "3" === s[1]
                    ? ((s = s[1]),
                      sessionStorage.setItem("sensors_heatmap_type", s))
                    : (s = null)
                  : (s =
      ...
      function t() {
        ...
        function t() {
          "object" == typeof window.SensorsData_APP_JS_Bridge &&
            ...
            ((s = SensorsData_APP_JS_Bridge.sensorsdata_call_app()),
            _.isJSONString(s) && (s = JSON.parse(s)));
        }
        function r() {
          if (
        ...
        (window.sensorsdata_app_js_bridge_call_js = function (t) {
          ...
          (sd.getAppStatus = function (e) {
            return (
              r(), t(), e ? void (null === s ? (n = e) : (e(s), (s = null))) : s
            );
          });
      }
      return (
